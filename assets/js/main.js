...
import { setTheme, updateCountLabel, renderPlayers, renderScoreboard, renderHistory } from './render.js';
import { start, reset, refreshActiveQuestion, openQ } from './game.js';
...
// ── Expose updateCountLabel for reset() fallback ──
window.__jeopardy__ = { updateCountLabel };
...
$('startTimerBtn').onclick  = () => startTimer(BASE_TIME, () => {
  // timer expired — auto-pass handled inside game.js via handlePass callback
});
